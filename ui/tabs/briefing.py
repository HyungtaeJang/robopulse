...
def render_tab_briefing(stats, articles):
    ...
    if st.session_state.briefing_filter_tag:
        ...
        with i_col1:
            # 버튼과 시각적 수평 선을 맞추기 위해 margin-top 조정
            st.markdown(f"""
                <div style="background-color: #eff6ff; color: #1e40af; padding: 0 15px; border-radius: 6px; border: 1px solid #dbeafe; font-size: 0.85rem; height: 38px; display: flex; align-items: center; margin-top: 1px;">
